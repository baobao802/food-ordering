        ...
        <aside className={sidebarIsOpen ? 'open' : ''}>
          <ul className="categories">
            ...
            {loadingCategories ? (
              ...
              categories.map((c) => (
                <li className='sidebar-category-item' key={c}>
                  <Link
                    style={{width:'100%'}}
