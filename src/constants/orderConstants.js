...
export const CONFIRM_PAIDED_SUCCESS = "CONFIRM_PAIDED_SUCCESS";
export const CONFIRM_PAIDED_REQUEST = "CONFIRM_PAIDED_REQUEST";
export const CONFIRM_PAIDED_FAIL = "CONFIRM_PAIDED_FAIL";
